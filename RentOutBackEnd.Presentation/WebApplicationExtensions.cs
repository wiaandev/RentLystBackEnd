...
public static class WebApplicationExtensions
{
    public static async Task Init(this WebApplication app)
    {
        ...
        // {
        //
        //     var connectionStringBuilder = new Npgsql.NpgsqlConnectionStringBuilder(app.Configuration.GetConnectionString("RentOutDatabase"));
        ...
        //
        //     var createDbSql = $"CREATE DATABASE RentOutDatabase";
        //
