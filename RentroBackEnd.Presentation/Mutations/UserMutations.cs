...
namespace RentroBackEnd.Presentation.Mutations;

[MutationType]
public class UserMutations
{
    public async Task<User?> Login([Service] UserManager<User> userManager, [Service] SignInManager<User> signInManager,
    ...
    public async Task<bool> Logout([Service] UserManager<User> userManager, [Service] SignInManager<User> signInManager,
        string email, string password)
    {
    ...
    public async Task<User> UserRegistration(AppDbContext dbContext, [Service] UserManager<User> userManager,
        UserRegistrationRequest input,
